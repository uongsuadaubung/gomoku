...
export const AI_LEVELS: LevelConfig[] = [
  {
    ...
    depth: 1,
    candidateCount: 5,
    threatVision: 0.45,    // Nhận biết 45% đe dọa trực diện (hay lơ đễnh để hở nước 4)
    attackWeight: 1.0,
  ...
  },
  {
    ...
    depth: 1,
    candidateCount: 6,
    threatVision: 0.68,    // Tăng nhẹ sự tập trung (nhận biết 68% hiểm họa trực diện)
    attackWeight: 1.0,
    defenseWeight: 0.50,   // Bắt đầu chú ý phòng thủ hơn một chút nhưng vẫn dễ chịu
    temperature: 0.55,     // Độ ngẫu nhiên giảm nhẹ, đánh chắc hơn Level 1
    vcfDepth: 0,
    color: '#14b8a6',

...
export const GUIDE_CHAPTERS: GuideChapter[] = [
  ...
  // ==========================================
  // CHƯƠNG 8: CHUYÊN ĐỀ LUẬT CẤM RENJU & BẪY PHẠM QUY (MỞ RỘNG)
  // ==========================================
  {
    id: 8,
    title: 'Chương 8: Chuyên Đề Mở Rộng - Luật Cấm Renju Quốc Tế (Tham Khảo)',
    vietnameseTitle: 'Luật Cấm Renju Quốc Tế (Tham Khảo)',
    badge: 'Mở Rộng Quốc Tế',
    iconName: 'Shield',
    description: 'Chuyên đề mở rộng giúp bạn hiểu sâu về Luật Cờ Renju thi đấu quốc tế. ⚠️ LƯU Ý: Game này chơi theo luật Gomoku tự do (Caro truyền thống) nên KHÔNG ÁP DỤNG LUẬT CẤM (bạn được tự do đánh 3-3, 4-4 và >5 quân để thắng). Phần này chỉ nhằm mục đích tham khảo mở rộng kiến thức!',
    lessons: [
      {
        id: 'lesson_8_1',
        chapterId: 8,
        order: 1,
        title: 'Nhận Diện 3 Luật Cấm Của Đen Trong Renju (Mở Rộng)',
        subtitle: 'Kiến thức tham khảo: Vì sao Renju quốc tế giới hạn sức mạnh của Đen?',
        difficulty: 'master',
        durationMinutes: 5,
        description: 'Chuyên đề tham khảo: Để cân bằng lợi thế đi trước, luật Renju quốc tế cấm Đen đi 3-3, 4-4 và Quá 5. (Trong game này KHÔNG CẤM, bạn được chơi hoàn toàn tự do).',
        coreConcepts: ['Luật Renju quốc tế (Tham khảo)', 'Cấm 3-3 / Cấm 4-4 (Renju)', 'Cấm Quá 5 (Overline)'],
        initialBoard: buildBoard([
          { r: 7, c: 5, p: BLACK }, // F8
          { r: 7, c: 6, p: BLACK }, // G8
          { r: 5, c: 7, p: BLACK }, // H10
        ...
        playerColor: BLACK,
        turnPlayer: BLACK,
        detailedArticle: `📢 **LƯU Ý QUAN TRỌNG TRƯỚC KHI TÌM HIỂU**:\nGame Caro / Gomoku bạn đang chơi áp dụng **Luật Tự Do (Freestyle Gomoku)** — nghĩa là hoàn toàn **KHÔNG CẤM** bất kỳ nước cờ nào! Bạn có thể thoải mái tung đòn 3-3, 4-4 hoặc xếp 6 quân trở lên để giành chiến thắng.\n\nBài học này là một **chuyên đề mở rộng** nhằm trang bị thêm kiến thức chuẩn quốc tế nếu bạn muốn tìm hiểu sâu về bộ môn cờ **Renju chuyên nghiệp**:\n\nTrong giải đấu Renju quốc tế, do quân Đen đi trước có ưu thế áp đảo nên bị giới hạn bởi **3 điều luật cấm**:\n1. **Cấm 3-3 (Double Three)**: Đen không được đánh 1 quân tạo ra 2 nước 3 mở cùng lúc.\n2. **Cấm 4-4 (Double Four)**: Đen không được đánh 1 quân tạo ra 2 nước 4 cùng lúc.\n3. **Cấm Quá 5 (Overline)**: Đen xếp từ 6 quân trở lên thẳng hàng không được tính thắng mà bị xử thua ngay!\n\n*(Quân Trắng hoàn toàn tự do: được phép đánh 3-3, 4-4 và Overline >= 6 quân vẫn được tính thắng trận).*`,
        summaryTakeaway: '📌 Nhớ rằng: Game của chúng ta KHÔNG CẤM! Bài học này chỉ giúp bạn hiểu thêm luật Renju quốc tế khi giao lưu chuyên nghiệp.',
        steps: [
          {
            stepIndex: 1,
            instruction: 'Góc nhìn Renju: Giả định chơi theo luật Renju cấm Đen 3-3 tại H8, hãy tìm nước đi an toàn khác tại I8!',
            initialBoard: buildBoard([
              { r: 7, c: 5, p: BLACK }, // F8
              { r: 7, c: 6, p: BLACK }, // G8
              { r: 5, c: 7, p: BLACK }, // H10
            ...
            hint: 'Giả định theo luật Renju cấm 3-3: Tránh ô H8 và đánh vào I8.',
            feedbacks: [
              {
                row: 7,
                col: 8,
                quality: 'best',
                explanation: 'Chính xác! Theo luật Renju quốc tế, bạn đã tránh được ô cấm 3-3 tại H8 và phát triển thế cờ an toàn tại I8. (Lưu ý: Trong game này, bạn đánh H8 vẫn hoàn toàn hợp lệ và là nước cờ cực mạnh!).',
              },
              {
                row: 7,
                col: 7,
                quality: 'blunder',
                explanation: 'Nếu thi đấu theo luật Renju quốc tế, đây là nước cấm 3-3 của Đen và bị xử thua. (Tuy nhiên trong game này luật tự do thì H8 là nước 3-3 thắng tuyệt đối!).',
                opponentResponse: { row: 7, col: 8 },
                opponentExplanation: 'Trong cờ Renju quốc tế, đối thủ sẽ bắt lỗi phạm quy 3-3 tại đây.'
              }
            ]
          }
        ]
      },
      {
        ...
        chapterId: 8,
        order: 2,
        title: 'Nghệ Thuật Bẫy Cấm (Foul Trap) Trong Renju (Mở Rộng)',
        subtitle: 'Đòn đánh đặc sản trong cờ Renju quốc tế dành cho quân Trắng',
        difficulty: 'master',
        durationMinutes: 5,
        description: 'Tìm hiểu đòn Foul Trap kinh điển của Renju: Trắng ép Đen phải chặn vào ô cấm 3-3/4-4. (Chuyên đề tham khảo mở mang kiến thức quốc tế, game này không cấm).',
        coreConcepts: ['Bẫy cấm (Foul Trap - Renju)', 'Đặc sản Renju quốc tế', 'Mở rộng kiến thức'],
        initialBoard: buildBoard([
          { r: 7, c: 5, p: BLACK }, // F8
          { r: 7, c: 6, p: BLACK }, // G8
          { r: 5, c: 7, p: BLACK }, // H10
        ...
        playerColor: WHITE,
        turnPlayer: WHITE,
        detailedArticle: `📢 **LƯU Ý**: Game của chúng ta **KHÔNG CÓ LUẬT CẤM** nên đòn bẫy này không dùng để xử thua đối thủ trong game được. Tuy nhiên, đây là một đòn chiến thuật trứ danh cực kỳ ảo diệu trong cờ **Renju quốc tế** mà bất kỳ kỳ thủ nào cũng nên biết!\n\nTrong cờ Renju quốc tế, **Bẫy Cấm (Foul Trap)** diễn ra như sau:\n- Trắng nhận thấy ô H8 là điểm giao cắt tạo 3-3 của Đen (ô cấm Đen không được đánh theo luật Renju).\n- Trắng tạo ra **Nước 4** nhắm thẳng vào ô H8, ép buộc Đen phải nhảy vào chặn.\n- Theo luật thi đấu, Đen bắt buộc phải chặn nước 4 tại H8, nhưng khi đặt quân vào H8 thì Đen lập tức phạm luật cấm 3-3 và bị xử thua ngay!\n- Đây là nét đẹp tư duy đỉnh cao độc quyền của luật Renju quốc tế.`,
        summaryTakeaway: '📌 Foul Trap là đòn độc quyền trong luật Renju quốc tế. Hãy học để mở rộng tầm mắt và hiểu sâu sự đa dạng của cờ Caro/Renju!',
        steps: [
          {
            stepIndex: 1,
            instruction: 'Trải nghiệm đòn Foul Trap của Renju: Đánh I8 tạo Nước 4 ép Đen rơi vào ô cấm H8!',
            initialBoard: buildBoard([
              { r: 7, c: 5, p: BLACK }, // F8
              { r: 7, c: 6, p: BLACK }, // G8
              { r: 5, c: 7, p: BLACK }, // H10
            ...
            targetMove: { row: 7, col: 8 }, // I8
            alternativeGoodMoves: [],
            hint: 'Đánh vào I8 tạo nước 4 để thử nghiệm bẫy Foul Trap theo luật Renju.',
            feedbacks: [
              {
                row: 7,
                col: 8,
                quality: 'best',
                explanation: 'Tuyệt tác bẫy cấm Foul Trap của Renju! Đen buộc phải chặn tại H8 và phạm quy 3-3 theo luật Renju quốc tế. (Trong game tự do của chúng ta, nước này vẫn là một nước 4 ép nhịp cực kỳ sắc bén của Trắng!).',
              }
            ]
          }
        ]

...
export const MainMenu: Component = () => {
  ...
  return (
    <div class="w-full max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6 flex flex-col gap-6 sm:gap-8 animate-fade-in select-none">
      
      {/* ========================================================================= */}
      {/* ⚔️ KHU VỰC 1: ĐẤU TRƯỜNG & THI ĐẤU (BATTLE & MATCH MODES)                 */}
      {/* ========================================================================= */}
      <div class="w-full flex flex-col gap-3.5">
          ...
          <div class="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p class="text-xs text-slate-400 font-medium">
                Thử thách bản lĩnh kỳ nghệ và leo tháp đối đầu 12 cao thủ Gomoku
              </p>
            </div>
          </div>
        </div>

        {/* Grid 3 Cards Thi Đấu */}
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 items-stretch">
          ...
          {/* 2. CỜ CHỚP (FLASH / BLITZ CHALLENGE) */}
          <ModeCard
          ...
          {/* 3. ĐẤU TÙY CHỌN VỚI BOT (CUSTOM MATCH) */}
          <ModeCard
      ...
      {/* ========================================================================= */}
      {/* 🎓 KHU VỰC 2: HỌC TẬP & KỲ VIỆN (ACADEMY & TRAINING MODES)                */}
      {/* ========================================================================= */}
      <div class="w-full flex flex-col gap-3.5 pt-2">
        {/* Section Header */}
        <div class="flex items-center justify-between gap-3 pb-2 border-b border-slate-800/80">
          <div class="flex items-center gap-2.5">
            ...
            <div>
              <div class="flex items-center gap-2">
                ...
                <span class="text-[10px] font-extrabold px-2 py-0.5 rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-500/30">
                  Giáo Trình & Gia Sư
                </span>
              </div>
              <p class="text-xs text-slate-400 font-medium">
                Nâng tầm tư duy chiến thuật từ nhập môn tới đại kiện tướng
              </p>
            </div>
          </div>
        </div>

        {/* Grid 3 Cards Học Tập */}
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 items-stretch">

          {/* 1. KỲ VIỆN BÁCH KHOA & GIẢ LẬP (GUIDE & SANDBOX) */}
          <ModeCard
            title="Kỳ Viện Bách Khoa"
            description={`Giáo trình ${GUIDE_CHAPTERS.length} chương ${getAllLessons().length} bài từ mở màn tới sát cục & Phòng giả lập Radar toàn diện!`}
          ...
          >
            <div class="p-3 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-2">
              ...
              <div class="flex items-center justify-between text-xs pt-1.5 border-t border-slate-800/80">
                ...
                <span class="text-slate-200 font-bold">Heatmap & Radar</span>
              </div>
            </div>
          </ModeCard>

          {/* 2. HỌC VIỆN GOMO (TUTOR COACHING MODE) */}
          <ModeCard
            title="Học Viện Gomo"
          ...
          >
            <div class="p-3 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-2">
              ...
              <div class="flex items-center justify-between text-xs pt-1.5 border-t border-slate-800/80">
                ...
                <span class="text-slate-200 font-bold truncate max-w-[140px]">
          ...
          {/* 3. THẾ CỜ / PUZZLE (TACTICAL PUZZLE MODE) */}
          <ModeCard
